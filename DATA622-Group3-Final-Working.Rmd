...
all_metrics <- rbind(olr_final_metrics, svm_final_metrics, gbm_final_metrics)
all_accuracies <- as.data.frame(rbind(olr = olr_accuracy, svm = svm_acc2, gbm = gbm_acc2))
...
The prevalence can be used in combination with the Detection Rate to understand what portion of each class that the models correctly identified.
